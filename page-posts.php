			 ...
			 <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
				...
				<div class="entry">
					...
					<div class="indexexzerpt">
						...
						<?php the_excerpt(); ?><br>
						<a href="<?php the_permalink() ?>"><?php the_time('d. F Y') ?></a> &middot; <?php comments_popup_link(__('Deixe um comentário', 'picolight'), __('1 comentário', 'picolight'), __('% comentário', 'picolight')); ?>
